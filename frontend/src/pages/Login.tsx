      ...
      <div className="glass noise p-10 rounded-3xl max-w-md w-full border border-white/10 shadow-2xl">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-[var(--surface-hi)] text-white font-bold rounded-xl hover:scale-[1.02] transition-all border border-[var(--border)]"
          >
